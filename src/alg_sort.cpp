...
namespace {
    ...
    std::unordered_map<char, uint> calculate_occurrences(const std::vector<char>& colors, uint sort_b) {
    ...
    void _universal_sort(std::vector<char>& colors, uint sort_b, uint p_point_b, InstructionList& list) {
        std::unordered_map<char, uint> occur = calculate_occurrences(colors, sort_b);
